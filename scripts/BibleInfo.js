...
var BibleInfo = new function() {
	...
	this.osisNames = Array("Gen", "Exod", "Lev", "Num", "Deut", "Josh", "Judg", "Ruth", "1Sam", "2Sam", "1Kgs", "2Kgs", "1Chr", "2Chr", "Ezra", "Neh", "Esth", "Job", "Ps", "Prov", "Eccl", "Song", "Isa", "Jer", "Lam", "Ezek", "Dan", "Hos", "Joel", "Amos", "Obad", "Jonah", "Mic", "Nah", "Hab", "Zeph", "Hag", "Zech", "Mal", "Matt", "Mark", "Luke", "John", "Acts", "Rom", "1Cor", "2Cor", "Gal", "Eph", "Phil", "Col", "1Thess", "2Thess", "1Tim", "2Tim", "Titus", "Phlm", "Heb", "Jas", "1Pet", "2Pet", "1John", "2John", "3John", "Jude", "Rev");

	// These are lowercase for ease of searching
	this.osisToBookMap = {};
	this.osisNames.forEach((osisRef) => {
		let index = this.osisNames.indexOf(osisRef);
		this.osisToBookMap[osisRef.toLowerCase()] = this.bookNames[index];}
	);
	...
	this.isNTBook = function (bookName) {
		...
		If the reference is invalid, we return invalidValue.
		The OsisRef can be uppercase or lowercase or any combination.
		*/
	this.parseOsis = function (OsisReference, invalidValue = undefined) {
		let	pieces = OsisReference.split(".");
		let	abbr = pieces[0],
			retval = {
				"book": "",
				"chapter": pieces[1],
		...
		abbr = abbr.toLowerCase();
				...
				if (this.osisToBookMap.hasOwnProperty(abbr)) {
						retval.book = this.osisToBookMap[abbr];
						return retval;
						}
